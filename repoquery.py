...
#    --arch=noarch,x86_64 --requires --graphviz bash systemd kernel dracut bash
#
...
def parse_arguments(args):
    ...
    parser.add_argument('--graphviz', action='store_true',
                        help=_('output graphviz dot graph of dependencies'))
...
class RepoQueryCommand(dnf.cli.Command):
    ...
    def print_node(self, pkg, G=None):
        src=pkg.sourcerpm
